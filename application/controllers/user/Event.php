...
class Event extends User_Controller {
	private $services = null;
    private $name = null;
    private $parent_page = 'user';
	private $current_page = 'user/event/';
	
	public function __construct(){
		parent::__construct();
		$this->load->library('services/Event_services');
		$this->services = new Event_services;
	...
	public function index()
	{
		...
		$table[ "rows" ] = $this->event_model->events( $pagination['start_record'], $pagination['limit_per_page'] )->result();
		...
		$this->data["block_header"] = "Event";
		$this->data["header"] = "Event";
	...
	public function add(  )
	{
        ...
        else
        {
		  ...
		  $alert = $this->session->flashdata('alert');
			...
			$this->data["alert"] = (isset($alert)) ? $alert : NULL ;
			$this->data["current_page"] = $this->current_page;
			$this->data["block_header"] = "Buat Event ";
			$this->data["header"] = "Buat Event ";
			$this->data["sub_header"] = 'Klik Tombol Action Untuk Aksi Lebih Lanjut';
	...
	public function edit( $event_id = NULL )
	{
        ...
        else
        {
		  ...
		  $this->data["key"] = $this->input->get('key', FALSE);
            ...
            $form_data = $this->services->get_form_data( $event_id );
            $form_data = $this->load->view('templates/form/plain_form', $form_data , TRUE ) ;
