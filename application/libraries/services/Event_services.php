...
{
  const CONTENT_PATH = './uploads/event/';
  protected $id;
  ...
  {
    $filename = "EVENT_".$name."_".time();
    $upload_path = 'uploads/event/photo/';
  ...
  public function get_form_data( $event_id = NULL )
    ...
    if( $event_id != NULL )
    {
        ...
        $this->image_old        = $event->image_old;
    ...
    // try {
    //   $file_content = file_get_contents( Event_services::CONTENT_PATH . $this->file_content );
    // }
    ...
    // }
    if( file_exists( Event_services::CONTENT_PATH . $this->file_content ) )
    {
      $file_content = file_get_contents( Event_services::CONTENT_PATH . $this->file_content );
    }
    else
